package com.github.sample.list;
...
public class VideoListLayout extends RelativeLayout {
    ...
    private VPlayPlayer videoItemView;
    ...
    private void initActions() {
        ...
        adapter.setClick(new VideoAdapter.onClick() {
            ...
            public void onclick(int position) {
                ...
                if (videoItemView.getStatus() == PlayStateParams.STATE_PAUSED) {
            ...
            public void onChildViewAttachedToWindow(View view) {
                ...
                if (index == postion) {
                    ...
                    if (videoItemView != null &&
                            ((videoItemView.isPlay()) || videoItemView.getStatus() == PlayStateParams.STATE_PAUSED)) {
